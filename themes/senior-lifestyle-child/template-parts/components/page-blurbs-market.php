...
<section class="section-page-blurbs">
	<div class="section-header">
		<div class="section-title-with-line">
			<h2>Lifestyle Options and Levels of Care<?php the_field('section_title'); ?></h2>
		</div>
		<p>Choosing a senior living community is a decision that requires research and time. Understanding your care needs is essential to ensure the senior living community is the ideal fit. The most common community levels of care are Independent Living, Assisted Living, and Memory Care communities.</p>
	</div>
	<?php
